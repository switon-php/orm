...
class IdGeneratorTest extends TestCase
{
    ...
    protected MockObject|MakerInterface $mockMaker;
    ...
    protected function setUp(): void
    {
        ...
        $this->mockMaker = $this->createMock(MakerInterface::class);
        ...
        $this->container->set(MakerInterface::class, $this->mockMaker);
    ...
    public function testGenerateIdUsesConfiguredStrategyAndCachesGeneratorInstance(): void
    {
        ...
        $this->mockMaker->expects($this->once())
            ->method('make')
            ->with('Switon\\Id\\IdGeneratorInterface#snowflake')
    ...
    public function testGenerateIdCachesGeneratorsPerEntityClass(): void
    {
        ...
        $aliases = [];
        $this->mockMaker->expects($this->exactly(2))
            ->method('make')
            ->willReturnCallback(static function (string $alias) use (&$aliases, $snowflakeGenerator, $uuidGenerator): IdPackageInterface {
                $aliases[] = $alias;
