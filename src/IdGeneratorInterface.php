 ...
 *
 * Guidance:
 * - use this behind entity managers so ID strategy details stay outside repositories and entities
 * - batch fills should stay within one compatible entity type and one resolved shard when preallocation is involved
 *
 * Road-signs:
 * - generate single id
 * - generate batch ids
...
interface IdGeneratorInterface
{
     ...
     */
    public function generateIds(string $entityClass, int $count, mixed $context = null): array;
