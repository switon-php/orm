...
class IdGenerator implements IdGeneratorInterface
{
    ...
    /** @var NamedLookupInterface<IdPackageInterface> */
    ...
    protected function getGeneratorForClass(string $entityClass): ?IdPackageInterface
    {
        if (!array_key_exists($entityClass, $this->generatorsCache)) {
            ...
            if ($id === null || $id->strategy === 'auto') {
                ...
                $this->generatorsCache[$entityClass] = $this->namedLookup->by(IdPackageInterface::class, $generatorAlias);
            }
        }
    ...
    {
        return $this->getGeneratorForClass($entity::class)?->next();
    }
    ...
    /**
     * @param class-string<Entity> $entityClass
     * @param Entity|array<string, mixed>|null $context
     *
