 ...
 *
 * Guidance:
 * - use this as the write boundary behind repositories and specialized managers
 * - keep normal application writes on create/update/delete and reserve <code>put()</code> for trusted full-row inserts
 *
 * Road-signs:
 * - query entry
...
interface EntityManagerInterface
{
     ...
     *
     * @return QueryInterface<mixed> Query instance ready for chaining
     */
     ...
     *
     * @param T $entity Entity instance to create
     *
     ...
     *
     * @param array<int, T> $entities Entities to create (same type, same fields populated)
     *
     * @return array<int, T> Created entities
     *
     ...
     *
     * @param T $entity Entity with complete data (may include primary key)
     *
     * @return T Inserted entity
     *
     ...
     *
     * @param T $entity Entity instance with updated data
     * @param T $original Original entity instance for change detection
     *
     ...
     *
     * @param T $entity Entity instance to delete
     *
     * @return T Deleted entity snapshot
     *
