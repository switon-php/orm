...
{
    /**
     * Returns whether the entity class defines the named relationship.
     *
    ...
    /**
     * Returns the named relationship definition for the entity class.
     *
     * @param class-string<Entity> $entityClass Entity class name
     * @param string $name Relationship name
     *
    ...
    /**
     * Creates a lazy-loading query for one entity relationship.
     *
     ...
     *
     * @return QueryInterface<mixed> Query instance for the relationship
     *
    ...
    /**
     * Creates the related query for one eager-load payload.
     *
     ...
     *
     * @return QueryInterface<mixed> Query instance for related entities
     *
