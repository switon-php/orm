...
class Entity implements ArrayAccess, JsonSerializable, Stringable, ArrayableInterface
{
     ...
     *
     * @param array $data Optional array of data to initialize entity properties
     *
     * @example
     ...
     *
     * @param array|Entity $data Source data (array or entity instance)
     * @param array $fields Array of field names to assign
     *
