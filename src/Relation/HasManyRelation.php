...
class HasManyRelation extends AbstractRelation
{
     ...
     *
     * @param class-string<Entity> $relatedEntity The related entity class name
     ...
     * @param array<string, string> $orderBy Ordering specification for related entities (e.g., ['created_at' => SORT_DESC])
     */
     ...
     *
     * @return QueryInterface<mixed> Query builder with ordering configuration
     */
     ...
     *
     * @return QueryInterface<mixed> Query configured for lazy loading the related entities
     */
