...
class BelongsToRelation extends AbstractRelation
{
     ...
     *
     * @param array $r Array of child entity data
     * @param QueryInterface $relatedQuery Query builder for parent entities
     * @param string $name The relationship property name
     * @return array Updated child entity data with loaded relationships
     */
     ...
     * @return QueryInterface Query configured for lazy loading the parent entity
     */
