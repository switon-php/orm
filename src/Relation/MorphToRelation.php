...
class MorphToRelation extends AbstractRelation
{
     ...
     */
    #[Autowired] protected array $morphs = [];
     ...
     * @param QueryInterface<mixed> $relatedQuery Base query configuration applied to each resolved MorphTo target.
     * @param string $name The relationship property name
     *
     * @return array<int, array<string, mixed>|Entity> Updated entity data with loaded relationships
     */
     ...
     *
     * @return QueryInterface<mixed> Query configured for lazy loading
     */
     ...
     *
     * @param QueryInterface<mixed> $relatedQuery Query config to clone and retarget
     * @param class-string<Entity> $entityClass Resolved entity class name
     *
     * @return QueryInterface<mixed> Query retargeted to the resolved entity
     */
     ...
     *
     * @return QueryInterface<mixed> Query for the dynamic related entity
     */
