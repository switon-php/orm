...
abstract class AbstractRelation implements RelationInterface
{
     ...
     *
     * @param string $self The entity class that owns this relation
     * @param string $related The related entity class
     */
     ...
     *
     * @return QueryInterface Query builder for the related entity
     */
     ...
     *
     * @return string The fully qualified class name of the owning entity
     */
     ...
     *
     * @return string The fully qualified class name of the related entity
     */
