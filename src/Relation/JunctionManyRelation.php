...
class JunctionManyRelation extends AbstractRelation
{
     ...
     *
     * @param class-string<Entity> $junctionEntity The junction entity class name
     * @param class-string<Entity> $targetEntity The target entity class name (from property type)
     *
     * @return array [selfField, selfValue]
     * @return array{0: string|null, 1: string|null} [selfField, selfValue]
     */
