...
readonly class HasMany implements RelationAttribute
{
    /**
     * Creates a new HasMany relationship attribute instance.
     *
     * @param class-string<Entity> $foreignEntity The related entity class name (required)
     ...
     * @param class-string<RelationInterface> $handler Relation handler class name. Defaults to {@see \Switon\Orm\Relation\HasManyRelation}.
     */
    public function __construct(
        public string  $foreignEntity,
        public ?string $foreignKey = null,
        public array   $orderBy = [],
        public string  $handler = HasManyRelation::class
    ) {
    }
