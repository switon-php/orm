...
readonly class MorphTo implements RelationAttribute
{
    /**
     ...
     * @param class-string<RelationInterface> $handler Relation handler class name. Defaults to {@see \Switon\Orm\Relation\MorphToRelation}.
     */
    public function __construct(
        public string $tableField,
        public string $idField,
        public string $handler = MorphToRelation::class
    ) {
    }
