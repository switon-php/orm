...
class JunctionMany implements RelationAttribute
{
    /**
     ...
     * @param string $handler Relation handler class name. Defaults to {@see \Switon\Orm\Relation\JunctionManyRelation}.
     *                             Must implement {@see \Switon\Orm\RelationInterface}.
     */
    public function __construct(
        public readonly array  $orderBy = [],
        public readonly string $handler = JunctionManyRelation::class
    )
    {
    }
