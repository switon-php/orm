...
readonly class BelongsTo implements RelationAttribute
{
    /**
     ...
     * @param class-string<RelationInterface> $handler Relation handler class name. Defaults to {@see \Switon\Orm\Relation\BelongsToRelation}.
     */
    public function __construct(
        public ?string $foreignKey = null,
        public string  $handler = BelongsToRelation::class
    ) {
    }
