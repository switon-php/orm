...
class HasManyToMany implements RelationAttribute
{
     ...
     * @param string|null $foreignEntity Optional related entity class override after junction keys are inferred
     * @param array $orderBy Ordering specification for related entities (default: empty array)
     * @param string $handler Relation handler class name. Defaults to {@see \Switon\Orm\Relation\HasManyToManyRelation}.
