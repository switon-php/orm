...
interface RepositoryInterface
{
     ...
     *
     * @param array<string, mixed> $filters Filter array. See class-level "Filter Format" section.
     *                      (default: empty array = all entities)
     * @param array<int|string, string|array<string, mixed>> $fields Fields to select (default: empty array = all fields).
     *                      Use array keys for eager loading: `['roles' => ['role_id', 'role_name']]`
     * @param array<string, string|int> $orders Ordering specification (default: empty array = no ordering).
     *                      Format: `['field' => 'ASC']` or `['field' => 'DESC']` or `['field' => SORT_ASC]` or `['field' => SORT_DESC]`.
     *                      Multiple fields: `['created_at' => 'DESC', 'id' => 'ASC']`
     *
     * @return array<int, T> Array of entities matching the filters
     *
     ...
     * @param array<int|string, string|array<string, mixed>> $fields Fields to select (default: empty array = all fields)
     *
     * @return array<int|string, T> Entities as an associative array keyed by the specified field value
     *
     ...
     * @param array<string, mixed> $filters Filter array. See class-level "Filter Format" section.
     *                      (default: empty array = all entities)
     * @param array<int|string, string|array<string, mixed>> $fields Fields to select. Use array keys for eager loading relationships
     ...
     *
     * @return list<mixed> Array of field values
     *
     ...
     *
     * @return array<int|string, mixed> Dictionary indexed by key field, with values from value field
     *
     ...
     *
     * @param array<string, mixed> $data Array of field names and values
     *
     ...
     *
     * @param Entity|array<string, mixed> $entity Entity instance or array of data
     *
     ...
     *
     * @param array<int, Entity|array<string, mixed>> $entities Entities to create (can be Entity objects or data arrays, same fields populated)
     *
     * @return array<int, Entity> Created entities with generated IDs and auto-filled fields
     */
     ...
     * ```
     *
     * @param Entity|array<string, mixed> $entity Entity with complete data (can include primary key)
     *
     ...
     *
     * @param Entity|array<string, mixed> $entity Entity instance or array of data (array must include primary key)
     *
     ...
     *
     * @param int|string $id The primary key value
     * @param array<string, mixed> $data Array of field names and values to update
     *
     * @return T Updated entity
     *
     ...
     *
     * @param int|string $id The primary key value
     * @param array<string, int|float> $counters Array of field => value pairs to increment/decrement. Use negative values to decrement.
     *
