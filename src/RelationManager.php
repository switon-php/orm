...
class RelationManager implements RelationManagerInterface
{
    ...
    /**
     * Returns whether the named relation exists on the entity class.
     *
    ...
    /**
     * Returns the named relation definition for the entity class, or null when absent.
     *
     * @param class-string<Entity> $entityClass
     */
    ...
    /**
     * Returns the related query for one eager-load payload, applying field selection or callback customization.
     *
    ...
    /**
     * Performs eager loading for the requested relations and dispatches batch lifecycle events around each relation.
     *
     * @param class-string<Entity> $entityClass
     * @param array<string, array<int|string, string|array<string, mixed>>|QueryInterface<mixed>|callable> $withs
     *
     * @return array<Entity>
     */
    ...
    /**
     * Returns whether the eager-load payload uses one of the supported shapes.
     */
    ...
    /**
     * Splits one relation payload into direct select fields and nested child-with configuration.
     *
    ...
    /**
     * Builds the lazy-loading query for one entity relation and dispatches lazy-load lifecycle events.
     *
     * @return QueryInterface<mixed>
     */
