...
class EntityMetadata implements EntityMetadataInterface
{
    ...
    /** @var array<string, ReflectionClass> Cached reflection classes per entity class */
    ...
    /**
     * Gets reflection class for the entity.
     *
    ...
    /**
     * Gets a class-level attribute instance.
     *
     * @param class-string<Entity> $entityClass Entity class name
     * @param class-string $name Attribute class name
     * @return object|null Attribute instance or null if not found
     */
    ...
    /**
     * Gets connection name from entity attribute or returns default 'default'.
     *
     * @param class-string<Entity> $entityClass Entity class name
    ...
    /**
     * Infers primary key field name from table name.
    ...
    /**
     * Warms up referenced key metadata.
     *
    ...
    public function warmUp(string $entityClass): void
    {
        ...
        try {
            ...
            $this->getTable($entityClass, false);
            ...
            if (($attributes = $property->getAttributes(
                ...
                foreach ($attributes as $attribute) {
                    ...
                    if ($attributeArguments === []) {
                        ...
                        $constraint = $this->maker->make($attributeName, $attributeArguments);
                    }
    ...
    protected function buildRelations(string $entityClass, array $properties): array
    {
        ...
        foreach ($properties as $property) {
            ...
            // Bind relation to entity classes
            $relationHandler->bind($entityClass, $relatedEntityClass);
