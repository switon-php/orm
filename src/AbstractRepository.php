...
abstract class AbstractRepository implements RepositoryInterface
{
    ...
    /**
     * @return EntityManagerInterface<T>
     */
     ...
     *
     * @param array<string, mixed> $filters Filter array. See {@see \Switon\Orm\RepositoryInterface RepositoryInterface}
     ...
     * {@inheritDoc}
     *
     * @param Entity|array<string, mixed> $entity
     ...
     * {@inheritDoc}
     *
     * @param array<int, Entity|array<string, mixed>> $entities
     *
     * @return array<int, T>
