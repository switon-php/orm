 ...
 *
 * Guidance:
 * - treat this as the central reflection-and-cache boundary for entity mapping rules
 * - prefer explicit attributes when database naming or relation inference differs from conventions
 *
 * Road-signs:
...
interface EntityMetadataInterface
{
     ...
     * @param class-string<Entity> $entityClass Entity class name
     *
     * @return RepositoryInterface<Entity> Repository instance
     *
     ...
     *
     * @return \Switon\Query\QueryInterface<mixed> Query instance for chaining
     */
     ...
     * @param class-string<Entity> $entityClass Entity class name
     *
     * @return array<string, array<int, ConstraintInterface>> Field name => constraint array mapping
     *
