...
Security fixes are provided for **currently supported release lines** of `switon/orm` (`switon/orm` on Packagist).
...
1. **GitHub private vulnerability reporting (preferred)**  
   [Report a vulnerability](https://github.com/switon-php/orm/security/advisories/new)
